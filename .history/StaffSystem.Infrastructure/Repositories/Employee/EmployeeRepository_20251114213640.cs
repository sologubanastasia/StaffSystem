...
public class EmployeeRepository : IEmployeeRepository
{
    ...
    public IEnumerable<Employee> GetAll(string? department, string? position, string? name)
    {
        ...
        var sql = @"
            ...
            WHERE 
                -- ✅ ВИПРАВЛЕННЯ: Використовуємо COALESCE, щоб уникнути помилки 42P08 при NULL-параметрах
        ...
        // Npgsql знову не повинен мати проблем, оскільки COALESCE забезпечує тип TEXT
